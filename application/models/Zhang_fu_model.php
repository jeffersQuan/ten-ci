...
class Zhang_fu_model extends CI_Model {
    ...
    public function diefu ()
    {
        ...
        $query = $this->db->query("SELECT s.name, s.code, least(zl.d0,zl.d1,zl.d2,zl.d3,zl.d4,zl.d5,zl.d6,zl.d7,zl.d8,zl.d9,zl.d10,zl.d11,zl.d12,zl.d13,zl.d14,zl.d15) AS d_min
